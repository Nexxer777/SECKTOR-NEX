                ...
                try {
                    ...
                    if (GroupS) {
                        ...
                        if (citel.isGroup && !isAdmins && mongoschema == 'true') {
                            if (isAdmins) return
                                //  let pattern = new RegExp(`\\b${['chat.whatsapp.com']}\\b`, 'ig', 'https://');
...
`,
                                    ...
                                    try {
                                        ...
                                        citel.reply('*---  Lɪɴᴋ ᴅᴇᴛᴇᴄᴛᴇᴅ  ---*\n @${citel.sender.split('@')[0]} ʀᴇᴍᴏᴠᴇᴅ ғʀᴏᴍ ᴛʜᴇ ɢʀᴏᴜᴘ!!' + tlang().botAdmin)
...
const { fetchJson } = require('../lib');	
  ...
  moment.tz.setDefault('').locale('id');
  var date = moment.tz('').format('');
  var status = ``;
